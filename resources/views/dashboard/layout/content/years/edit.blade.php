        ...
        <div class="p-4 mb-0 space-y-6 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2">
            ...
            <form action="{{ route('years.update', $year) }} " method="POST">
                ...
                <div class="grid gap-6 mb-3 lg:grid-cols-2">
                    <div>
                        <label for="yearName" class="block mb-2 text-sm font-medium text-gray-900">Event's
                            City</label>
